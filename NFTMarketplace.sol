...
contract NFTMarketplace is ReentrancyGuard {
    ...
    receive() external payable {
        // You can leave this empty if you just want to receive Ether
    }

    // Fallback function to handle direct calls
    fallback() external payable {
        // Optionally handle Ether sent directly to the contract without calling a specific function
    }
